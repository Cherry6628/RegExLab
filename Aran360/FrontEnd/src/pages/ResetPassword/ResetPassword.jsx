...
export default function ResetPassword() {
    ...
    return (
        <div className="reset-page-wrapper">
            ...
            <main className="reset-main-content">
                <div className="reset-branding-section">
                    <div
                        className="reset-illustration-container"
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="reset-mockup-lines">
                                <div className="reset-m-line reset-m-line-sm"></div>
                                <div className="reset-m-line reset-m-line-lg"></div>
                                <div className="reset-m-line reset-m-line-lg"></div>
                            </div>
                        </div>
                    </div>
                    <div className="reset-branding-text">
            ...
            <footer className="reset-footer-bar">
                <p className="reset-copyright-text">
                    ©&nbsp;2026&nbsp;Aran&nbsp;360&nbsp;
                    All&nbsp;rights&nbsp;reserved.
                </p>
                <div className="reset-legal-links">
