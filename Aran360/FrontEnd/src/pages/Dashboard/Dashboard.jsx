...
export default function Dashboard() {
    ...
    const currentTopicData = hasStarted
        ? Object.values(learningData).find(
              (topic) => topic?.url === lastTopicUrl,
          )
        : null;
            ...
            return (
                <>
                    ...
                    <Button
                        ...
                        onClick={() =>
                            navigate(
                                "/learning-material/" + lastTopicUrl + "#last",
                            )
                        }
                    >
                        Resume Learning
            ...
            <div id="dashboard">
                ...
                <div className="quizReleaseCard">
                    <h3 className="quizTitle">
                        🚀 Today: Tradeshow Special Quiz!
                    </h3>
                    <p className="quizDescription">
                        Attend the quiz now and climb the leaderboard. Don’t
