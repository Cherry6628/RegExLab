...
export default function Header() {
  ...
  const isKnowledgeActive = location.pathname.startsWith("/learning-material/");
        ...
        <nav className={`nav-menu ${menuOpen ? "open" : ""}`}>
          <ul className="navlist">
            ...
            <li className="navitem-container" ref={listRef}>
              <p
                className={`navitem ${
                  dropdownOpen || isKnowledgeActive ? "active" : ""
                }`}
              ...
              <ul className={`dropdown-menu ${dropdownOpen ? "show" : ""}`}>
                {Object.keys(context.learningData).map((key) => (
                  <li key={key}>
                    <NavLink
                      to={"/learning-material/" + context.learningData[key].url}
            ...
            <li ref={profileRef} className="navitem-container">
              {context.uname ? (
                <>
                  ...
                  >
                    <li>
                      <NavLink to="/accounts" onClick={closeAll}>
                        Profile
                      </NavLink>
                    </li>
                    <li>
