      ...
      <div id="QuizMain">
        {display == 0 && (
          <main className="content">
            ...
            <p>
              Select a vulnerability domain to begin your interactive training
              session. Each
              <br />
              path contains hands-on labs and theoretical assessments.
            </p>
            <div className="separate">
              ...
              />
              <VulnerabilityTopic
                onClick={async () => await takeTest("SQL Injection (SQLi)")}
                icon="database"
              ...
              />
              <VulnerabilityTopic
                onClick={async () => await takeTest("Access Control")}
                icon="shield"
              ...
              />
              <VulnerabilityTopic
                onClick={async () => await takeTest("Authentication")}
                icon="key"
              ...
              />
              <VulnerabilityTopic
                onClick={async () => await takeTest("Path Traversal")}
                icon="folder"
              ...
              />
              <VulnerabilityTopic
                onClick={async () => await takeTest("Race Condition")}
                icon="shuffle"
                heading="Race Condition"
                content="A Race Condition occurs when multiple processes or threads access and manipulate shared data concurrently without proper synchronization. This can lead to unpredictable behavior, data corruption, authentication bypass, or privilege escalation if operations are executed in an unintended order."
              />
            </div>
          </main>
        )}
