...
export default function AccessControl(){
        ...
        <div id='xss'>
            <section className='mainbar'>
                ...
                <section>
                    ...
                    <Lab>Unprotected admin functionality</Lab>
	...
	if (isAdmin) {
		...
		...
                    ...
                    <Lab>Unprotected admin functionality with unpredictable URL</Lab>
                    ...
                    <Lab>User role controlled by request parameter</Lab>
                    <Lab>User role can be modified in user profile</Lab>
                    ...
                    <Lab>URL-based access control can be circumvented</Lab>
                    ...
                    <Lab>Method-based access control can be circumvented</Lab>
                ...
                <section>
                    ...
                    <Lab>User ID controlled by request parameter </Lab>
                    <p>In some applications, the exploitable parameter does not have a predictable value. For example, instead of an incrementing number, an application might use globally unique identifiers (GUIDs) to identify users. This may prevent an attacker from guessing or predicting another user's identifier. However, the GUIDs belonging to other users might be disclosed elsewhere in the application where users are referenced, such as user messages or reviews. </p>
                    <Lab>User ID controlled by request parameter, with unpredictable user IDs </Lab>
                    ...
                    <Lab>User ID controlled by request parameter with data leakage in redirect </Lab>
                </section>
                <section>
                    ...
                    <Lab>User ID controlled by request parameter with password disclosure</Lab>
                </section>
                <section>
                    ...
                    <Lab>Insecure direct object references</Lab>
                    <div className="labbox">
                        <h3>Read more</h3>
                        <ul>
                ...
                <section>
                    ...
                    <Lab>Multi-step process with no access control on one step </Lab>
                    ...
                    <Lab>Referer-based access control </Lab>
