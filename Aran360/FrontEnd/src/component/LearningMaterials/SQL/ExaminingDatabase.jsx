        ...
        <div id='xss'>
            <section className='mainbar'>
                <section>
                    ...
                    <p>To exploit SQL injection vulnerabilities, it's often necessary to find information about the database. This includes:</p>
                    <ul>
                        <li>The type and version of the database software.</li>
                        <li>The tables and columns that the database contains.</li>
                    </ul>
                </section>
                <section>
...
Microsoft, MySQL <span>SELECT @@version</span><br/>
Oracle	         <span>SELECT * FROM v$version</span><br/>
PostgreSQL       <span>SELECT version()</span></pre>
                    <p>For example, you could use a <span>UNION</span> attack with the following input:</p>
                ...
                <section>
                    ...
                    <p>For example, you can query <span>information_schema.tables</span> to list the tables in the database:</p>
                    <Payloads>SELECT * FROM information_schema.tables</Payloads>
                    <p>This returns output like the following:</p>
                    <Payloads><pre>TABLE_CATALOG  TABLE_SCHEMA  TABLE_NAME  TABLE_TYPE<br/>=====================================================<br/>MyDatabase     dbo           Products    BASE TABLE<br/>MyDatabase     dbo           Users       BASE TABLE<br/>MyDatabase     dbo           Feedback    BASE TABLE</pre></Payloads>
                    <p>This output indicates that there are three tables, called <span>Products</span>, <span>Users</span>, and <span>Feedback</span>.</p>
                    <p>You can then query <span>information_schema.columns</span> to list the columns in individual tables:</p>
                    <Payloads>SELECT * FROM information_schema.columns WHERE table_name = 'Users'</Payloads>
                    <p>This returns output like the following:</p>
